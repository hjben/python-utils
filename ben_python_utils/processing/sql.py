"""
This module provide some utilities to manage or generate string-formatted SQL statements.

Functions:
    - generate_insert_sql: generate inserting SQL with a DataFrame.
    - generate_update_sql: generate updating SQL with a DataFrame.
    - add_condition_to_sql: add where statement to a SQL.
    - generate_select_sql: generate selecting SQL with filtering informations.
    - generate_delete_sql: generate deleting SQL with filtering informations.
"""
import copy
import pandas as pd
